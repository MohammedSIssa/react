export default function Hero() {
  return (
    <div className="h-screen flex flex-col justify-center lg:flex-row lg:justify-around lg:items-center">
      <div className="flex-col gap-1 sm:gap-2 md:gap-4 lg:gap-5 h-1/3 md:w-full md:h-full lg:w-3/5 text-3xl text-center lg:text-6xl text-cyan-200 flex justify-center items-center bg-cyan-900 lg:h-dvh">
        <h1 className="max-w-2/3 lg:max-w-full font-bold md:text-4xl lg:text-5xl">
          Landing Page
        </h1>
        <p className="text-cyan-100 text-xl sm:text-2xl">TailwindCSS + React + Vite</p>
      </div>
